...
#define DFSDM_TypeDef DFSDM_Filter_TypeDef
  ...
  typedef struct
  {
    ...
    uint32_t
        RESERVED0[4]; /*!< Reserved, 0x1C - 0x2B                                                                 */
    __IO uint32_t
        PCR; /*!< DSI Host Protocol Configuration Register,                  Address offset: 0x2C       */
    __IO uint32_t
    ...
    uint32_t
        RESERVED1[2]; /*!< Reserved, 0xB4 - 0xBB                                                                 */
    __IO uint32_t
    ...
    uint32_t
        RESERVED6[7]; /*!< Reserved, 0x11C - 0x137                                                               */
    __IO uint32_t
  ...
  typedef struct
  {
    ...
    uint32_t
        RESERVED1[2]; /*!< Reserved, 0x24-0x28                                                          */
    __IO uint32_t
...
#if defined(STM32F413_423xx)
    __IO uint32_t
        MCHDLYCR; /*!< SYSCFG multi-channel delay register,               Address offset: 0x30      */
#endif            /* STM32F413_423xx */
  } SYSCFG_TypeDef;
